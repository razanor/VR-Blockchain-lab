...
<a-scene id="scene" visible="false" vr-mode-ui="enabled: false">
  ...
  <a-gltf-model src="#museum" position="-20.374 0 12.194" scale="0.9 0.9 0.9">
    <!-- Images collaction -->
    <a-image src="#img0" width="3.448" height="5.172" position="15.918 3.483 -25.544" scale="1 1 1" cursor-enter cursor-leave>
    ...
    <a-image src="#img1" width="3.448" height="5.172" position="23.685 3.483 -25.544" scale="1 1 1" cursor-enter cursor-leave>
             <a-text id="author0" visible="false" position="1.653 3.121 0"></a-text>
             <a-text id="text0" height="7" width="4" align="center" visible="false" position="3.798 0 0"></a-text>
    </a-image>
    <a-image src="#img2" width="3.448" height="5.172" position="33.295 3.483 -25.544" scale="1 1 1" cursor-enter cursor-leave>
    ...
    <a-image src="#img3" width="3.448" height="5.172" position="41.041 3.483 -25.544" scale="1 1 1" cursor-enter cursor-leave>
    ...
    <a-image src="#img4" width="3.448" height="5.172" position="43.645 3.483 -22.579" scale="1 1 1" rotation="0 -90 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img5" width="3.448" height="5.172" position="43.645 3.483 -15.028" scale="1 1 1" rotation="0 -90 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img6" width="3.448" height="5.172" position="43.645 3.483 -7.482" scale="1 1 1" rotation="0 -90 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img7" width="3.448" height="5.172" position="24.742 3.483 -1.849" scale="1 1 1" rotation="0 -180 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img8" width="3.448" height="5.172" position="32.271 3.483 -1.849" scale="1 1 1" rotation="0 -180 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img9" width="3.448" height="5.172" position="40.016 3.483 -1.849" scale="1 1 1" rotation="0 -180 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img10" width="4.355" height="3.451" position="37.536 3.554 -26.781" scale="1 1 1" rotation="0 180 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img11" width="3.448" height="5.172" position="19.587 3.483 -50.767" scale="1 1 1" rotation="0 0 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img12" width="3.448" height="5.172" position="36.846 3.483 -50.767" scale="1 1 1" rotation="0 0 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img13" width="4.355" height="3.451" position="19.414 3.554 -26.781" scale="1 1 1" rotation="0 180 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img14" width="3.448" height="5.172" position="43.645 3.663 -39.849" scale="1 1 1" rotation="0 -90 0" cursor-enter cursor-leave>
    ...
    <a-image src="#img27" width="3.448" height="5.172" position="13.281 3.663 -62.228" scale="1 1 1" rotation="0 90 0" cursor-enter cursor-leave>
            <a-text id="author26" visible="false" position="-5.351 3.300 0"></a-text>
            <a-text id="text26" height="7" width="4" align="center" visible="false" position="-3.843 -0.384 0"></a-text>
    </a-image>
    ...
    <!-- Select language text -->
      <a-text position="13.307 5.167 -9.648" rotation="0 90 0" value="Choose language" width="15" color="#351252"></a-text>
  ...
  <a-light type="ambient" color="#ffffff" intensity="0.700"></a-light>
    ...
    <a-cylinder radius="0.3" height="0.06" position="-5.824 -0.250 -6.078" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -5.824 2.020 -6.078">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="1.116 -0.250 -6.078" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 1.116 2.020 -6.078">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="9.448 -0.250 -6.078" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 9.448 2.020 -6.078">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="16.515 -0.250 -6.078" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 16.515 2.020 -6.078">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="14.618 -0.250 -8.099" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 14.618 2.020 -8.099">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="14.618 -0.250 -1.595" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 14.618 2.020 -1.595">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="14.618 -0.250 5.436" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 14.618 2.020 5.436">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="1.914 -0.250 5.436" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 1.914 2.020 5.436">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="8.457 -0.250 5.436" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 8.457 2.020 5.436">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="13.424 -0.250 -15.777" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 13.424 2.020 -15.777">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="5.251 -0.250 -11.360" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 5.251 2.020 -11.360">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-3.035 -0.250 -15.777" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -3.035 2.020 -15.777">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-4.669 -0.250 -14.432" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -4.669 2.020 -14.432">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-4.669 -0.250 -21.458" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -4.669 2.020 -21.458">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-4.669 -0.250 -28.778" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -4.669 2.020 -28.778">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="5.251 -0.250 -21.640" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 5.251 2.020 -21.640">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="5.251 -0.250 -34.127" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 5.251 2.020 -34.127">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="5.251 -0.250 -43.112" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 5.251 2.020 -43.112">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-2.779 -0.250 -29.328" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -2.779 2.020 -29.328">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="13.008 -0.250 -29.377" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 13.008 2.020 -29.377">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="15.057 -0.250 -23.891" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 15.057 2.020 -23.891">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="15.057 -0.250 -30.118" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 15.057 2.020 -30.118">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="15.057 -0.250 -16.787" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 15.057 2.020 -16.787">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="16.193 -0.250 -38.177" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 16.193 2.020 -38.177">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="9.612 -0.250 -38.177" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 9.612 2.020 -38.177">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="14.785 -0.250 -49.087" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 14.785 2.020 -49.087">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="14.785 -0.250 -39.584" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 14.785 2.020 -39.584">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-4.231 -0.250 -36.700" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -4.231 2.020 -36.700">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-4.231 -0.250 -43.151" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -4.231 2.020 -43.151">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-4.231 -0.250 -50.237" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -4.231 2.020 -50.237">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="-1.844 -0.250 -38.177" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: -1.844 2.020 -38.177">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="2.905 -0.250 -50.237" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 2.905 2.020 -50.237">
    </a-cylinder>
    <a-cylinder radius="0.3" height="0.06" position="11.480 -0.250 -50.237" color="#351252"
                event-set__teleport="_event: mouseenter; _target: #camera; position: 11.480 2.020 -50.237">
    </a-cylinder>
